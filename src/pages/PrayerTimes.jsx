  ...
  return (
    <section id="prayer" className="bg-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl font-semibold text-green-800 mb-6">Today's Prayer Times</h2>
        {prayerTimes ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 text-lg font-medium">
            {["Fajr", "Dhuhr", "Asr", "Maghrib", "Isha"].map((name) => (
              <div key={name} className="bg-green-50 rounded-lg shadow p-4">
                <h3 className="text-green-700">{name}</h3>
